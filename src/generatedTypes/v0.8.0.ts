...
export interface AppDataRootSchema {
  ...
  metadata: Metadata;
  backend?: OffChainOrderParameters;
  [k: string]: unknown;
}
/**
...
/**
 * Additional off-chain order swap parameters.
 */
export interface OffChainOrderParameters {
  version?: Version4;
  hooks?: CoWHooks;
  [k: string]: unknown;
}
/**
 * Custom CoW Hooks to be executed with an order
 */
export interface CoWHooks {
  pre?: PreHooks;
  post?: PostHooks;
  [k: string]: unknown;
}
